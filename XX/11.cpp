...
int main()
{
  ...
  for(int i = 0, rowCount = 0; i < data.size(); i++)
  {
    ...
    product = (down > product) ? down : product;
    product  = (diagRight > product) ? diagRight : product;
    product  = (diagLeft > product) ? diagLeft : product;
  }

  std::cout << "The greatest product is: " << product << std::endl;
  return 0;
}